...
export const mockUsers: User[] = [
  { id: 'u1', name: 'FactFinder007', points: 1250, badges: ['Top Verifier', 'Pioneer'] },
  { id: 'u2', name: 'TruthSeekerX', points: 980, badges: ['Contributor'] },
  { id: 'u3', name: 'SourceScout', points: 760, badges: [] },
  { id: 'u4', name: 'DebunkingDiva', points: 540, badges: ['Contributor'] },
  { id: 'u5', name: 'VeracityVanguard', points: 320, badges: [] },
];
